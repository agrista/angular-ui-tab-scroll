...
angular.module('ui.tab.scroll', [])
    .provider('scrollableTabsetConfig', function(){
            ...
            return {
                ...
                setAutoHideButtons : function(value){
                    config.autoHideButtons = (value == true);
                },
                ...
                $get: function(){
                    return {
                        ...
                        autoHideButtons: config.autoHideButtons,
            ...
            return {
                ...
                link: function($scope, $el) {
                    ...
                    $scope.reCalcAll = function() {
                        ...
                        var autoHideButtons = $scope.autoHideButtons ? $scope.autoHideButtons === 'true' : scrollableTabsetConfig.autoHideButtons;

                        $scope.hideButtons = autoHideButtons && $scope.tabContainer.scrollWidth <= $scope.tabContainer.offsetWidth;
